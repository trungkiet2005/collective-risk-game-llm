...
\begin{frame}{Baseline — phớt lờ rủi ro (so với người)}
  \centering\includegraphics[height=0.70\textheight]{figs/A_reach_vs_risk.png}
...
\begin{frame}{Baseline — đóng góp cũng phẳng, chỉ khác độ hào phóng}
  \centering\includegraphics[height=0.66\textheight]{figs/B_contrib_vs_risk.png}
...
\begin{frame}{Baseline — “vân tay” lựa chọn của mỗi mô hình}
  \centering\includegraphics[height=0.64\textheight]{figs/H_choice_dist.png}
...
\begin{frame}{Baseline — “vân tay” tách theo 3 mức rủi ro}
  \centering\includegraphics[height=0.62\textheight]{figs/H2_choice_dist_risk.png}
...
\begin{frame}{Baseline — ngôn ngữ: tiếng Anh vs tiếng Việt}
  \centering\includegraphics[height=0.66\textheight]{figs/I_lang_baseline.png}
...
\begin{frame}{Baseline — hợp tác TĂNG dần (ngược người)}
  \centering\includegraphics[height=0.66\textheight]{figs/C_round_dynamics.png}
...
\begin{frame}{Memory — chỉ Gemma bị ảnh hưởng}
  \centering\includegraphics[height=0.66\textheight]{figs/M_memory.png}
...
\begin{frame}{Memory — động lực vòng: full-history vs scratchpad}
  \centering\includegraphics[height=0.66\textheight]{figs/M2_memory_dynamics.png}
...
\begin{frame}{Framing — \emph{giảm bao nhiêu} đóng góp (mạnh hơn ở tiếng Việt)}
  \centering\includegraphics[height=0.66\textheight]{figs/FR_framing.png}
...
\begin{frame}{Framing — \emph{ai hỏng} mục tiêu (tỉ lệ đạt: chỉ Gemma rớt)}
  \centering\includegraphics[height=0.66\textheight]{figs/FR3_framing_reach.png}
...
\begin{frame}{Persona — thao tác hiệu quả nhất}
  \centering\includegraphics[height=0.66\textheight]{figs/D_persona_reach.png}
...
\begin{frame}{Persona — reach chỉ là “xác suất dải cắt 120”}
  \centering\includegraphics[height=0.66\textheight]{figs/D2_persona_dispersion.png}
...
\begin{frame}{Persona — một động cơ tuyến tính, ba chế độ}
  \centering\includegraphics[height=0.66\textheight]{figs/E_persona_linear.png}
...
\begin{frame}{Persona — ăn ở cấp cá nhân, nhưng Qwen ít nghe}
  \centering\includegraphics[height=0.64\textheight]{figs/G_disposition.png}
...
\begin{frame}{Persona — sụp đổ của Gemma là do tiếng Anh}
  \centering\includegraphics[height=0.62\textheight]{figs/J_persona_lang.png}
...
\begin{frame}{Persona — kiểm chứng tính vững (vị trí ghế)}
  \centering\includegraphics[height=0.64\textheight]{figs/Q_persona_variance.png}
...
\begin{frame}{Hiệu quả kinh tế — ai “khôn” nhất?}
  \centering\includegraphics[height=0.64\textheight]{figs/P_efficiency.png}
