...
\begin{frame}{Được ngay: model thôi đốt tiền vô ích}
  \centering\includegraphics[height=0.66\textheight]{R1_excess.png}
...
\begin{frame}{Cơ chế: thấy ``đủ rồi'' là dừng ngay lập tức}
  \centering\includegraphics[height=0.64\textheight]{R3_brake.png}
...
\begin{frame}{Nhịp chơi đổi hẳn: hết ``tăng dần tới chót''}
  \centering\includegraphics[height=0.60\textheight]{R4_dynamics.png}
...
\begin{frame}{Vân tay lựa chọn: mức ``0'' lần đầu xuất hiện thật sự}
  \centering\includegraphics[height=0.72\textheight]{R8_choice.png}
  \take{Qwen-7B: \weak{0\%}$\to$\good{22\%} chọn 0; Qwen-32B \weak{3\%}$\to$\good{16\%}. Model học được cách \emph{không} đóng.}
\end{frame}

\begin{frame}{Bổ theo rủi ro: nhịp chơi có đổi khi 10\% / 50\% / 90\% không?}
  \centering\includegraphics[width=\linewidth,height=0.70\textheight,keepaspectratio]{R4B_dynamics_risk.png}
  \take{Cùng một hình dạng ở cả ba mức rủi ro. Cái đổi được nhịp chơi là \good{hàng}
  (can thiệp prompt), \weak{không phải cột} (mức rủi ro).}
\end{frame}

\begin{frame}{Bổ theo rủi ro: vân tay lựa chọn cũng không nhúc nhích}
  \centering\includegraphics[width=\linewidth,height=0.70\textheight,keepaspectratio]{R8B_choice_risk.png}
  \take{Từ 10\% lên 90\% rủi ro, tỉ lệ chọn ``0'' lệch nhiều nhất \weak{2,8 điểm \%} (Qwen-7B).
  Risk-blindness không chỉ ở tỉ lệ đạt --- nó nằm ngay trong \emph{từng lượt chọn}.}
\end{frame}
...
\begin{frame}{Phép thử cốt lõi vẫn trượt y như cũ}
  \centering\includegraphics[height=0.66\textheight]{R2_reach_risk.png}
...
\begin{frame}{Cái giá phải trả: Gemma từ 100\% xuống trượt vạch}
  \centering\includegraphics[height=0.60\textheight]{R5_gemma_cost.png}
...
\begin{frame}{Vì sao trượt? Con số dùng để DỪNG được, để BÙ thì không}
  \centering\includegraphics[height=0.58\textheight]{R6_asymmetry.png}
...
\begin{frame}{Cùng một can thiệp, hai chiều tác động ngược nhau}
  \centering\includegraphics[height=0.62\textheight]{R7_payoff.png}
...
\begin{frame}{Trục ngôn ngữ vẫn còn}
  \centering\includegraphics[height=0.60\textheight]{R9_lang.png}
