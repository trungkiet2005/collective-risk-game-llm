...
\newcommand{\designhead}[7]{%
  ...
  \node[text=white,font=\fsize{14}\bfseries,inner sep=0pt] at (#1,#2) {#3};
...
\begin{tikzpicture}[x=1mm,y=-1mm,text=Ink,
  ...
  % -------------------- (a) THE GAME --------------------
  \path[rounded corners=1.8mm,fill=white] (1,1) rectangle (92,89);
  \begin{scope}
    \clip[rounded corners=1.8mm] (1,1) rectangle (92,89);
    \fill[Blue] (1,1) rectangle (92,8.8);
  \end{scope}
  \path[rounded corners=1.8mm,draw=BlueLine,line width=.55pt]
    (1,1) rectangle (92,89);
  \node[anchor=west,text=white,font=\fsize{14}\bfseries,inner sep=0pt]
    at (3.5,4.9) {(a)\quad The game};

  \card{3}{10.6}{55.5}{60.4}{PanelWash}{GeminiLine}
  \card{57.5}{10.6}{90}{60.4}{white}{GeminiLine}
  ...
  \card{3}{62}{90}{87}{PanelWash}{GeminiLine}
  ...
  \card{96}{10.6}{185}{28.6}{ModelWash}{GeminiLine}
  ...
  \card{96}{30.2}{139.5}{57.8}{SelfWash}{GeminiLine}
  \card{141.5}{30.2}{185}{57.8}{PromptWash}{ClaudeLine}
  \card{96}{59.4}{139.5}{87}{ScriptWash}{QwenLine}
  \card{141.5}{59.4}{185}{87}{MixedWash}{GrokLine}

  \designhead{101.4}{35.2}{1}{Blue}{121.6}{Self-play}{same model $\times 6$}
  \designhead{146.9}{35.2}{2}{Orange}{167.1}{Prompt tests}{prompt variants}
  \designhead{101.4}{64.4}{3}{Purple}{121.6}{Scripted partners}{fixed partners}
  \designhead{146.9}{64.4}{4}{Gold}{167.1}{Mixed tables}{two models}
