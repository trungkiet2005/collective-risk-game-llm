...
sample size. All games are in English, at temperature $0.7$, with every seat holding a
neutral persona.
...
a decision; every game reported here has zero parse failures and zero truncations across
$\PanelNdecisionsAll$ decisions.
...
common random numbers, which is what makes the paired comparisons across $p$ in
