"""
=====================================================================
CRSD (package `crsd`) — Kaggle OFFLINE notebook (Internet OFF, GPU ON) — exp_memory_ablation | MULTI-MODEL
=====================================================================
...
EXPERIMENTS = ["exp_memory_ablation"]   # notebook chuyen cho experiment nay (EN + VN)
